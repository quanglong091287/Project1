...
<c:url value="/admin-guideline-listen-edit.html" var="listtenGuideLineEditUrl">
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <a href="${listtenGuideLineEditUrl}"type="button">Thêm bài hướng dẫn nghe</a>
                    ...
                    <div class="table-responsive">
                        <fmt:bundle basename="ApplicationResources">
                            <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}"
                                           pagesize="${items.maxPageItems}" sort="external" requestURI="${requestURI}"
